...
const HeroSlide: React.FC<HeroSlideProps> = ({
  ...
  return <div className="relative w-full h-full min-h-[280px]">
      ...
      {mindBlowCount && mindBlowCount > 0 && <div className="absolute top-4 right-16 z-30">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 z-10">
        ...
        {creatorDisplay && <motion.p className="text-sm text-white/80" initial={{
        opacity: 0
      }} animate={{
        opacity: 1
      }} transition={{
