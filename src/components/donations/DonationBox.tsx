...
const DonationBox: React.FC<DonationBoxProps> = ({ compact = false }) => {
    ...
    return (
      <>
        <Button 
          variant="outline" 
          size="sm" 
          className="text-xs border-white/10 hover:bg-white/10 flex items-center gap-1.5"
          onClick={() => handleShowDonation(false)}
        >
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button 
            ...
            size="sm"
            className="border-white/10 hover:bg-white/10 flex items-center gap-1.5"
            onClick={() => handleShowDonation(true)}
          >
            <Heart size={14} className="text-red-400" />
